...
env.DHUB_PROJECT = "analytics"
env.DHUB_USER = "jenkins"
env.DHUB_PASS = ""
env.SERVICE_NAME = "settings-service"
...
node('slave-swarm-dind') {
    timestamps {
        ...
        checkout scm
        git url: 'https://github.com/PicsArt/settings-service.git', branch: env.BRANCH_NAME, credentialsId: 'd3a36e01-c34a-41b6-96f9-fbea0131315e'
        }
